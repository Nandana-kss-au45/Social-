    ...
    <div className='rightbar'>
      <div className='rightcontainer'>
        <div className='adsContainer'>
          ...
          <div>
            <p style={{ textAlign: 'start', marginLeft: '10px', marginTop: -20 }}>attainu CodeDemy</p>
        ...
        <div className='adsContainer'>
          ...
          <div>
            <p style={{ textAlign: 'start', marginLeft: '10px', marginTop: -20 }}>javascript CodeDemy</p>
            <p style={{ textAlign: 'start', marginLeft: '10px', fontSize: "12px", marginTop: "-16px" }}>Buy  attainu codedemy course</p>
          </div>
        </div>
        ...
        <div style={{marginTop:"-10px"}}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: "center" }}>
              ...
              <div>
                <p style={{ marginLeft: "10px" , textAlign:'start' }}>Nandana</p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: "center" }}>
              ...
              <div>
                ...
                <p style={{ marginLeft: "10px" , textAlign:'start' , marginTop:"-16px" , fontSize:"11px" , color:"#aaa" }}>Followed by Nandana</p>
              </div>
            </div>
            <div style={{ backgroundColor: "#aaa", padding: '10px', marginRight: 13, borderRadius: "50%", cursor:'pointer' }}>
              <img src={`${addFriends}`} className="addfriend" alt="" />
